...
@section('content')
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="card-body">
                <a href="{{ route('user.create') }}" type="button" class="btn btn-success btn-sm mb-3"><i
                        class="fa-solid fa-plus"></i> Tambah</a>
                <div class="table-responsive">
                    <table id="user-table" class="table table-bordered table-striped dataTable" deferRender="true">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama User</th>
