                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="mb-3">
                                    ...
                                    @enderror
                                    @if ($barang->image)
                                        <img src="/gambar_barang/{{ $barang->image }}" height="200px">
                                    @endif
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('bisa_disewa') is-invalid @enderror" id="bisa_disewa"
                                        name="bisa_disewa">
                                        <option value="0" {{ $barang->bisa_disewa == '0' ? 'selected' : '' }}>Tidak
                                        </option>
                                        <option value="1" {{ $barang->bisa_disewa == '1' ? 'selected' : '' }}>Ya
                                        </option>
                                    </select>
                                    @error('bisa_disewa')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('stok') is-invalid @enderror"
                                        id="stok" name="stok" value="{{ $barang->stok }}">
                                    @error('stok')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
