            ...
            <div class="row">
                <div class="col-md-5 mx-auto">
                    <div class="card">
                        ...
                        <div class="container">
                            <div class="card-body">
                                <form method="POST" class="form-login" action="{{ route('pelanggan.login') }}">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div>
                                        Belum punya akun? <a href="{{ route('pelanggan.register.form') }}"
                                            style="text-decoration: none">Daftar
                                            Akun</a>
                                    </div>
                                    <div style="margin-bottom: 2rem; color: black"><a href="#"
