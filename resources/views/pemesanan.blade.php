        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <label for="" style="font-weight: bold"><i class="fas fa-money-bill-wave"></i> Total
                            Harga</label><br>
                        ...
                        <div class="mt-3">
                            ...
                            @if ($pemesanan->status === 'Dikirim')
                                <span><i class="fas fa-info-circle"></i> Jika produk sudah diterima harap selesaikan pesanan
                                    anda</span>
                                <form action="{{ route('pemesanan.selesai', ['id' => $pemesanan->id]) }}" method="POST"
                                    class="mt-2">
                                    @csrf
                                    @method('PUT')
                        ...
                        <div class="mt-3">
                            <label for="" style="font-weight: bold"><i class="fas fa-calendar-alt"></i> Tanggal
                                Pemesanan</label><br>
                    ...
                    <div class="card-body">
                        @if ($pemesanan->pengiriman)
                            ...
                            @elseif ($pemesanan->pengiriman->pelanggan)
                                <div class="form-group">
                                    <label for="" style="font-weight: bold"><i class="fas fa-user"></i> Nama
                                        Customer</label><br>
                                    <span>{{ $pemesanan->pengiriman->pelanggan->name }}</span>
                                </div>
                            @else
                                <span><i class="fas fa-info-circle"></i> Informasi pengiriman belum tersedia.</span>
                            @endif
                            <label for="" style="font-weight: bold"><i class="fas fa-map-marker-alt"></i> Alamat
                                Pengiriman</label><br>
            ...
            <div class="col-lg-6">
                <div class="card mt-4">
                    @if ($pemesanan->pembayaran)
                        ...
                        <div class="card-body">
                            <img src="/bukti_pembayaran/{{ $pemesanan->pembayaran->bukti_pembayaran }}" width="50%"
                                alt="Bukti Pembayaran" class="rounded">
                        </div>
                    @else
                        <div class="card-header text-center" style="background: #4F200D; color: white">
                        ...
                        <div class="card-body">
                            <form action="{{ route('pembayaran.store', ['id' => $pemesanan->id]) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="" style="font-weight: bold"><i class="fas fa-credit-card"></i>
                                        Metode Pembayaran</label><br>
                                    <span>{{ $pemesanan->metodePembayaran->name_metode }}</span>
                                </div>
                                <div class="form-group">
                                    <label for="" style="font-weight: bold"><i class="fas fa-info-circle"></i> Harap
                                        Melakukan Pembayaran Melalui
                                        Keterangan
                                        Dibawah ini</label><br>
